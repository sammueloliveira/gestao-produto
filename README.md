...
Este repositório contém um sistema de **Cadastro de Produtos** desenvolvido com **Angular** no front-end e **.NET Core** no back-end. O objetivo do sistema é permitir o cadastro, edição, listagem e exclusão de produtos, com suporte à gestão de departamentos.
